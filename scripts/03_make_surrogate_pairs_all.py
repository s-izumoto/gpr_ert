...
DEFAULT_SCRIPT = str(Path("build/ert_physics_forward_all.py").resolve())
...
def main():
    ...
    ap.add_argument("--script", default=DEFAULT_SCRIPT, help="Path to ert_physics_forward_all.py (override)")
    ...
    # Smart defaults for this project bundle
