...
Usage is analogous to 04_make_oracle_masks.py. Example YAML:
...
def main():
    ...
    ap.add_argument("--script", default=str(Path("./build/build_oracle_value.py")),
