...
def _simulate_one_field(args_tuple):
    ...
    if pattern == "wenner-alpha":
        ...
        # fallback to simple adjacent-dipole "alpha-ish" stepping inside ALL electrodes (legacy light mode)
        # A-M-N-B = (i, i+1, i+2, i+3) and increase the spacing
...
if __name__ == "__main__":
    ...
    ap.add_argument("--n-active-elec", type=int, default=16)
